...
root_path = "/data/TheStack_IR/OJ_Samples/Collated/Haskell"    
out_path = "/data/TheStack_IR/OJ_Samples/Scripts/Haskell"
...
def compile_worker(dir_list_chunk):
    ...
    with (
        ...
        for folder in tqdm(
            ...
            src_path = f"{root_path}/{folder}/source.hs"
            def_path = f"{root_path}/{folder}/source.ll"
            ...
            perf_mov_returncode = subprocess.call(
                [
                    "mv", 
                    f"{def_path}",
                    f"{perf_path}"
            ...
            size_mov_returncode = subprocess.call(
                [
                    "mv", 
                    f"{def_path}",
                    f"{size_path}"
