...
root_path = "/home/ubuntu/Downloads/Collated/Nim"    
out_path = "/home/ubuntu/Downloads/Scripts/Nim"
...
def compile_worker(dir_list_chunk):
    ...
    with (
        ...
        for folder in tqdm(
            ...
            src_path = f"{root_path}/{folder}/source.nim"
            perf_path = f"{root_path}/{folder}/llvm_O3.ll"
            size_path = f"{root_path}/{folder}/llvm_OZ.ll"

            perf_returncode = subprocess.call(
                [
                    "/home/ubuntu/Downloads/WorkDir/nlvm/nlvm/nlvm", "compile", 
                    "--llvm-emit-call-site-info", 
                    "--llvm-Oz", 
                    "--opt:speed", 
                    "--compileOnly:on", 
                    "-o:llvm_OZ.ll", 
